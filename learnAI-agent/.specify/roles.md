...
### Primary Outputs
- `learnAI-Mobile/app/src/main/kotlin/com/learnagenticai/ui/` — All Composables & screens
- `learnAI-Mobile/app/src/main/kotlin/com/learnagenticai/viewmodel/` — ViewModels
- `learnAI-Mobile/app/src/main/res/` — Resources (drawables, values, themes)
...
### Primary Outputs
- `learnAI-Mobile/app/src/main/kotlin/com/learnagenticai/data/` — Repositories, DTOs, DAOs
...
### Primary Outputs
- `learnAI-Mobile/app/src/test/` — Unit tests (JVM)
- `learnAI-Mobile/app/src/androidTest/` — Compose UI + integration tests

# Steering File: Senior Backend Engineer
## Agent Identity: agent/backend

### Mission
Design APIs, Room schema, Repository implementations, DTOs
...
### Operating Worktree
```bash
git worktree add .git/worktrees/backend-agent -b agent/backend
cd .git/worktrees/backend-agent
```

### Communication
- Log your progress to `.specify/memory/agent-log-backend.md`
